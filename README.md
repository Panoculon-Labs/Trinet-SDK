...
|---|---|---|
| **Android** | Prebuilt **AAR** (`com.panoculon:trinet-sdk:0.1.7`) + docs; demo APKs under [Releases](../../releases) | this page ↓ |
...
The AAR lives in [`aar/`](aar/) (Maven coordinates `com.panoculon:trinet-sdk:0.1.7`).
...
dependencies {
    implementation(":trinet-sdk-0.1.7@aar")
...
dependencies: [
    .package(url: "https://github.com/Panoculon-Labs/Trinet-SDK", from: "0.1.7"),
],
targets: [
