...
|---|---|---|
| **Android** | Prebuilt **AAR** (`com.panoculon:trinet-sdk:0.2.1`) + docs; demo APKs under [Releases](../../releases) | this page ↓ |
...
The AAR lives in [`aar/`](aar/) (Maven coordinates `com.panoculon:trinet-sdk:0.2.1`).
...
dependencies {
    implementation(":trinet-sdk-0.2.1@aar")
